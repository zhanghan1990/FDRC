...
TCP_pair instproc setup {snode dnode deadlinedown deadlineup} {
...
Agent_Aggr_pair instproc check_if_behind {} {
    ...
    $self instvar tnext
    $self instvar deadline_down deadline_up
	...
	$apair($nr_pairs) setup $s_node $d_node $deadline_down $deadline_up
...
Agent_Aggr_pair instproc setup {snode dnode tbflist tbfindex gid nr init_fid agent_pair_type deadlinedown deadlineup} {
#Public
#Note:
...
#and each of them has its own flow id: init_fid + [0 .. nr-1]
    ...
    $self instvar deadline_down deadline_up; # upper and lower bound of flow deadline
	...
	$apair($i) setup $snode $dnode $deadlinedown $deadlineup
